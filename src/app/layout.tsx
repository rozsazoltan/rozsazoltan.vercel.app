...
export const metadata: Metadata = {
  ...
  description:
    "I am a PHP and JavaScript developer. I work with Laravel and Vue.js, I also have extensive experience with other frameworks.",
};
  ...
  return (
    ...
    >
      <head>
        ...
        <link rel="mask-icon" href={v("/favicons/safari-pinned-tab.svg")} color="#ec5c5c" />
        ...
        <meta name="apple-mobile-web-app-title" content="rosazoltan" />
        <meta name="application-name" content="Trosazoltan" />
        <meta name="msapplication-TileColor" content="#ec5c5c" />
