...
export const metadata: Metadata = {
  title: "What's new from Laravel 12",
  description:
    "...",
  openGraph: {
    type: "article",
    title: "What's new",
    description: "...",
    images: "https://rozsazoltan.vercel.app/api/og?path=/docs/laravel/installation/whats-new",
    url: "https://rozsazoltan.vercel.app/docs/laravel/installation/whats-new",
  },
};
