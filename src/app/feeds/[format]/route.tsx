...
const BASE_URL = "https://rozsazoltan.github.io";
...
export async function GET(request: Request, { params }: { params: Promise<{ format: string }> }) {
  ...
  const feed = new Feed({
    ...
    copyright: `All rights reserved ${new Date().getFullYear()}, rozsazoltan`,
    feedLinks: {
    ...
    author: {
      name: "Zoltán Rózsa",
      link: "https://twitter.com/@rozsazoltan_dev",
    },
  });
