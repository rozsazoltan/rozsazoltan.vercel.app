...
export default function NotFoundPage() {
  return (
    <div className="max-w-screen overflow-x-hidden">
      ...
      <div className="grid min-h-[calc(100dvh-var(--spacing)*14.25)] grid-cols-1 grid-rows-auto justify-center pt-14.25 [--gutter-width:2.5rem] lg:grid-cols-[var(--gutter-width)_minmax(0,var(--breakpoint-2xl))_var(--gutter-width)]">
        <div></div>
        
        {/* Main content area */}
        <div className="text-gray-950 dark:text-white">
          <div className="flex h-[calc(100dvh-var(--spacing)*14.25)] items-center justify-center">
