...
const HOST = process.env.NODE_ENV === "development" ? `http://localhost:3000` : `https://rozsazoltan.vercel.app`;
...
export async function GET(req: NextRequest) {
  ...
  return new ImageResponse(
    (
      ...
      >
        <div tw="absolute flex h-full w-full flex-col justify-between p-[32px] pt-[351px] pl-[85px] pr-[45px]">
          <div tw="flex flex-col h-full p-8">
            {section && (
              <div
