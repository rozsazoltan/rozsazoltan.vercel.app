        ...
        <div className="flex flex-wrap items-center">
          ...
          {showcase.isTemplate && (
            <p
              ...
              className="ml-2 rounded-full border border-transparent bg-rose-100 px-1.5 text-[0.6875rem] leading-5 font-semibold text-rose-500 dark:bg-gray-600/50 dark:text-gray-200 dark:group-hover:bg-rose-500 dark:group-hover:text-white"
            >
              Template
            </p>
          )}
