...
function CubeIconSvg ({ name, type }: Pick<ServiceItemProps, "name" | "type">) {
  ...
  if (false) {
    return (
      <svg className="w-full" width="36" height="57" viewBox="0 0 36 57" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g>
          <path d="M10.9993 32.9L18.7931 33.35L26.5877 23.9L26.5875 27.05L18.7929 36.5L10.999 36.05L10.9993 32.9ZM11 23L18.7939 23.45L26.5885 14L26.5879 21.65L18.7933 31.1L10.9994 30.65L11 23Z" fill="#F9F9F8"></path>
        </g>
      </svg>
    )
  }
...
export function ServiceItem({
  ...
  const id = name
    ...
    .normalize("NFD")                     // ékezetek szétválasztása
    .replace(/[\u0300-\u036f]/g, "")      // ékezetek eltávolítása
    .replace(/[^a-z]/g, "");              // csak angol abc marad
